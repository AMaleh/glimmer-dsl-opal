...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/glimmer-dsl-opal/samples/elaborate/tetris/view/game_over_dialog.rb",
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<opal-async>.freeze, ["~> 1.3"])
    ...
    s.add_dependency(%q<opal-async>.freeze, ["~> 1.3"])
